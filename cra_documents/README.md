...
This directory contains core CRA regulatory documents for bookkeeping and expense
management RAG ingestion.
...
- **Source**:
  https://www.canada.ca/content/dam/cra-arc/formspubs/pub/t4002/t4002-24e.pdf
...
- **Size**: 180 KB (6 pages)
- **Source**:
  https://www.canada.ca/content/dam/cra-arc/formspubs/pub/ic05-1r1/ic05-1r1-10e.pdf
...
1. Date of purchase
1. Name and address of seller/supplier
1. Name and address of buyer
1. Full description of goods/services
1. Vendor's business number (for GST/HST registrants on purchases $100+)
1. GST/HST information or applicable tax rate
...
1. **HTML Processing**: Parse `GST-HST-Memo-8-4-Documentary-Requirements.html` with
   BeautifulSoup or similar
1. **Chunking Strategy**:
   - Chunk by regulation topic (expense categories, retention rules, invoice
     requirements)
...
Records must be kept for **6 years** from the end of the tax year (with specific
exceptions per section 5800 of Income Tax Regulations)
...
These are the latest publicly available versions as of October 2025. Archived versions
dating back to 1988 are available for T4002 at the CRA website.
