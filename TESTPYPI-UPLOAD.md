...
5. Verify badges display (some may not work on TestPyPI)
...
- **Fix**: Check `unzip -l dist/*.whl` for correct structure, verify dependencies in pyproject.toml
...
2. Verify package structure: `unzip -l dist/*.whl`
3. Test in clean environment before uploading
4. Review TestPyPI documentation: https://test.pypi.org/help/
